    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('ENG', 'English'), ('TH', 'Thai')], default=yumelinkapp.utils.type_enums.language_type.LanguageType['ENG'], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('content', 'Content filter violation'), ('hate', 'Hate speech'), ('inappropriate_content', 'Inappropriate Content'), ('violence', 'Violence'), ('cyberbully', 'Cyberbullying'), ('fake_user', 'Identity impersonation'), ('fake', 'Fake news'), ('child_exploitation', 'Child Exploitation'), ('scam_fraud', 'Scam or Fraud'), ('other', 'Other')], default=yumelinkapp.utils.type_enums.report_type.ReportType['other'], max_length=100)),
                ('content', models.TextField(default='', max_length=5000)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reporter', to='yumelinkapp.user')),
            ],
        ),
        migrations.AddField(
            model_name='post',
